...
class TestCaseFolder(models.Model):
    ...
    created_by = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="created_testcase_folders",
        verbose_name="创建人",
    )
    ...
    class Meta:
        db_table = "testcase_folders"
        verbose_name = "测试用例文件夹"
        verbose_name_plural = "测试用例文件夹"
        ordering = ["name", "id"]
        constraints = [
            models.UniqueConstraint(
                fields=["project", "name"],
                name="uniq_testcase_folder_name_per_project",
            )
        ]
