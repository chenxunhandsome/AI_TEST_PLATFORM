export default {
  ...
  element: {
    ...
    locatorTip: {
      ...
      parameterized: '参数化定位：支持变量、内置函数和运行时保存变量，例如',
      other: '其他策略请输入对应属性的值'
    },
    rules: {
      ...
      pageNameNoPathSeparator: '文件夹名称不能包含 /、\\、>、-> 等层级分隔符，请使用普通文字命名',
  ...
  testCase: {
    ...
    attributeName: '属性名称：',
    attributePlaceholder: '输入属性名，如 visible、clickable、value、class；多个用逗号分隔',
