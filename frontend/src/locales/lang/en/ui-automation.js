export default {
  ...
  project: {
    ...
    memberCountText: '{count} members',
    ownerOnlyTip: 'Only the project owner can manage project settings and members. Members can collaboratively maintain elements and test cases.',
    collaborationTip: 'Added members can collaborate on elements, page objects, scripts, test cases, suites and executions in this UI automation project.',
    rules: {
    ...
    messages: {
      ...
      ownerOnlyAction: 'Only the project owner can modify project settings and members',
  ...
  element: {
    ...
    rules: {
      ...
      pageNameNoPathSeparator: 'Folder name cannot contain hierarchy separators such as /, \\, >, or ->. Use plain text instead',
  ...
  testCase: {
    ...
    actionGetAttribute: 'Get Element Attribute',
    ...
    attributePlaceholder: 'Enter attribute, e.g. visible, clickable, value, class. Separate multiple with commas',
